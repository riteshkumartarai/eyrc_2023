...
# Filename:		bot_3_controller.py
# Functions:
#			[ inverse_kinematics,turn,goalCallback,callback_pose]
# Nodes:		publish-'/hb_bot_3/left_wheel_force','/hb_bot_3/right_wheel_force','/hb_bot_3/rear_wheel_force'
#               subscribe-'/detected_aruco_3'
...
class HBController(Node):
    def __init__(self):
        super().__init__('hb_controller_bot3')
        ...
        self.sub=self.create_subscription(Pose2D,'/detected_aruco_3',self.callback_pose,10)
        self.pub_left=self.create_publisher(Wrench,'/hb_bot_3/left_wheel_force',10)
        self.pub_right=self.create_publisher(Wrench,'/hb_bot_3/right_wheel_force',10)
        self.pub_rear=self.create_publisher(Wrench,'/hb_bot_3/rear_wheel_force',10)
