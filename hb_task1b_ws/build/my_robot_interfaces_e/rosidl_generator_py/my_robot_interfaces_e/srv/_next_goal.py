...
class Metaclass_NextGoal_Request(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            module = import_type_support('my_robot_interfaces_e')
        except ImportError:
            import logging
            import traceback
...
class Metaclass_NextGoal(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'my_robot_interfaces_e.srv.NextGoal')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
            ...
            from my_robot_interfaces_e.srv import _next_goal
...
class NextGoal(metaclass=Metaclass_NextGoal):
    from my_robot_interfaces_e.srv._next_goal import NextGoal_Request as Request
    from my_robot_interfaces_e.srv._next_goal import NextGoal_Response as Response
