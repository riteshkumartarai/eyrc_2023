...
#include "my_robot_interfaces_e/srv/detail/next_goal__rosidl_typesupport_fastrtps_c.h"
...
#include "my_robot_interfaces_e/msg/rosidl_typesupport_fastrtps_c__visibility_control.h"
...
using _NextGoal_Request__ros_msg_type = my_robot_interfaces_e__srv__NextGoal_Request;
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_my_robot_interfaces_e
size_t get_serialized_size_my_robot_interfaces_e__srv__NextGoal_Request(
  const void * untyped_ros_message,
...
static uint32_t _NextGoal_Request__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_my_robot_interfaces_e__srv__NextGoal_Request(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_my_robot_interfaces_e
size_t max_serialized_size_my_robot_interfaces_e__srv__NextGoal_Request(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
...
static size_t _NextGoal_Request__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_my_robot_interfaces_e__srv__NextGoal_Request(
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, my_robot_interfaces_e, srv, NextGoal_Request)() {
...
using _NextGoal_Response__ros_msg_type = my_robot_interfaces_e__srv__NextGoal_Response;
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_my_robot_interfaces_e
size_t get_serialized_size_my_robot_interfaces_e__srv__NextGoal_Response(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _NextGoal_Response__ros_msg_type * ros_message = static_cast<const _NextGoal_Response__ros_msg_type *>(untyped_ros_message);
...
{
  return static_cast<uint32_t>(
    get_serialized_size_my_robot_interfaces_e__srv__NextGoal_Response(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_my_robot_interfaces_e
size_t max_serialized_size_my_robot_interfaces_e__srv__NextGoal_Response(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
...
static size_t _NextGoal_Response__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_my_robot_interfaces_e__srv__NextGoal_Response(
    full_bounded, is_plain, 0);
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, my_robot_interfaces_e, srv, NextGoal_Response)() {
...
// already included above
// #include "my_robot_interfaces_e/msg/rosidl_typesupport_fastrtps_c__visibility_control.h"
#include "my_robot_interfaces_e/srv/next_goal.h"
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, my_robot_interfaces_e, srv, NextGoal)() {
