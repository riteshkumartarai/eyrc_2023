...
bool my_robot_interfaces_e__srv__next_goal__request__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("my_robot_interfaces_e.srv._next_goal.NextGoal_Request", full_classname_dest, 53) == 0);
  }
  my_robot_interfaces_e__srv__NextGoal_Request * ros_message = _ros_message;
  {  // request_goal
...
PyObject * my_robot_interfaces_e__srv__next_goal__request__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("my_robot_interfaces_e.srv._next_goal");
...
ROSIDL_GENERATOR_C_EXPORT
bool my_robot_interfaces_e__srv__next_goal__response__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("my_robot_interfaces_e.srv._next_goal.NextGoal_Response", full_classname_dest, 54) == 0);
  }
  my_robot_interfaces_e__srv__NextGoal_Response * ros_message = _ros_message;
  {  // x_goal
